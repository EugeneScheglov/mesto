...
var userId; // Возвращает результат нужных промисов //

api.getAllNeededData().then(function (_ref) {
  var _ref2 = _slicedToArray(_ref, 2),
      cards = _ref2[0],
      userItems = _ref2[1];

  userInfo.getUserInfo(userItems);
  userId = userItems._id; // Установка данных профиля//
...
var profileSample = new PopupWithForm({
  ...
  handleSubmitForm: function handleSubmitForm(data) {
    ...
    api.setUserInfo(data).then(function (data) {
...
cardImagePopup.setEventListeners(); // Образец создания карточки //
